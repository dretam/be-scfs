...
public class ParameterJenisTransaksiRtgsPredicate {

    public static Predicate[] listBuild(CriteriaBuilder cb, Root<ParameterJenisTransaksiRtgsJpaEntity> root, String filter) {
    ...
    public static Predicate[] retrieveBuild(CriteriaBuilder cb, Root<ParameterJenisTransaksiRtgsJpaEntity> root, ParameterJenisTransaksiRtgsId id) {
        List<Predicate> predicates = new ArrayList<>();
