...
public class ParameterJenisNasabahPenerimaPredicate {

    public static Predicate[] listBuild(CriteriaBuilder cb, Root<ParameterJenisNasabahPenerimaJpaEntity> root, String filter) {
    ...
    public static Predicate[] retrieveBuild(CriteriaBuilder cb, Root<ParameterJenisNasabahPenerimaJpaEntity> root, ParameterJenisNasabahPenerimaId id) {
        List<Predicate> predicates = new ArrayList<>();
