...
public class ParameterAutomaticTransferPredicate {

    public static Predicate[] listBuild(CriteriaBuilder cb, Root<ParameterAutomaticTransferJpaEntity> root, String filter) {
    ...
    public static Predicate[] retrieveBuild(CriteriaBuilder cb, Root<ParameterAutomaticTransferJpaEntity> root, ParameterAutomaticTransferId id) {
        List<Predicate> predicates = new ArrayList<>();
