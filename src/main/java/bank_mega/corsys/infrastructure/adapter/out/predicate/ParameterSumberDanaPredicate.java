...
public class ParameterSumberDanaPredicate {

    public static Predicate[] listBuild(CriteriaBuilder cb, Root<ParameterSumberDanaJpaEntity> root, String filter) {
    ...
    public static Predicate[] retrieveBuild(CriteriaBuilder cb, Root<ParameterSumberDanaJpaEntity> root, ParameterSumberDanaId id) {
        List<Predicate> predicates = new ArrayList<>();
