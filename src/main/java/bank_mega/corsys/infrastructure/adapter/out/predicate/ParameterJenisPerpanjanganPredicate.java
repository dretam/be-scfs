...
public class ParameterJenisPerpanjanganPredicate {

    public static Predicate[] listBuild(CriteriaBuilder cb, Root<ParameterJenisPerpanjanganJpaEntity> root, String filter) {
    ...
    public static Predicate[] retrieveBuild(CriteriaBuilder cb, Root<ParameterJenisPerpanjanganJpaEntity> root, ParameterJenisPerpanjanganId id) {
        List<Predicate> predicates = new ArrayList<>();
