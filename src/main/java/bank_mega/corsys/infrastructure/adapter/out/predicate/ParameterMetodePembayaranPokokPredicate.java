...
public class ParameterMetodePembayaranPokokPredicate {

    public static Predicate[] listBuild(CriteriaBuilder cb, Root<ParameterMetodePembayaranPokokJpaEntity> root, String filter) {
    ...
    public static Predicate[] retrieveBuild(CriteriaBuilder cb, Root<ParameterMetodePembayaranPokokJpaEntity> root, ParameterMetodePembayaranPokokId id) {
        List<Predicate> predicates = new ArrayList<>();
