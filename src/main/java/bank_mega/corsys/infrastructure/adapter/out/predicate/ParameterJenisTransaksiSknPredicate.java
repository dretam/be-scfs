...
public class ParameterJenisTransaksiSknPredicate {

    public static Predicate[] listBuild(CriteriaBuilder cb, Root<ParameterJenisTransaksiSknJpaEntity> root, String filter) {
    ...
    public static Predicate[] retrieveBuild(CriteriaBuilder cb, Root<ParameterJenisTransaksiSknJpaEntity> root, ParameterJenisTransaksiSknId id) {
        List<Predicate> predicates = new ArrayList<>();
