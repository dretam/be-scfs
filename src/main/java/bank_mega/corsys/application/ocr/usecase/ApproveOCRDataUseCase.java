...
public class ApproveOCRDataUseCase {

    private final OCRDataRepository ocrDataRepository;

    @Transactional
    public List<OCRResponse> execute(ApproveOCRDataCommand command, User authPrincipal) {
        ...
        for (Long id : command.ids()) {
            ...
            OCRData approvedData = OCRData.builder()
                    .id(ocrData.getId())
